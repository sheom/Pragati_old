...
import HotelAllStep from "./quarterForms/HotelAllStep";
...
const HotelAllTargetFormWidget = ({ propertyName, propertyCode, propertyId }) => {
  ...
  const getBudget = async () => {
    ...
    const response = await fetch(
      `https://sheom.in/budget?propertyCode=${propertyCode}&budgetYear=${fye}`,
      {
...
export default HotelAllTargetFormWidget;
